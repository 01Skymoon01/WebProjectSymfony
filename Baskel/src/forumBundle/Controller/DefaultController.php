...
class DefaultController extends Controller
{
    ...
    public function viewcatAction(Request $request,$id)
    {
        dump($id);
        $em = $this->getDoctrine()->getManager();
        $c = $em->getRepository('forumBundle:Category')->findAll();
...
//        );
    ...
    public function addCommentAction(Request $request,$id)
    {
        ...
        return $this->render('@forum/Default/singlePost.html.twig');
    ...
    public function UpdatePostAction(\Symfony\Component\HttpFoundation\Request $request , $id){
        $em = $this->getDoctrine()->getManager();
        //$modele = $em->getRepository("EspritParcBundle:Model")->find($id);
        $post = $em->getRepository("forumBundle:Postsforum")->find($id);
        $em = $this->getDoctrine()->getManager();
        $category= $em->getRepository('forumBundle:Category')->find($request->get('category'));
        //$post = new Postsforum();
