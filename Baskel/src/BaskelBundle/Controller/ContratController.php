...
use BaskelBundle\Entity\Contrat;
...
class ContratController extends Controller
{
    ...
    public function AfficheContratAction()
    {
        ...
        return $this->render('@Baskel/Default/afficheContrat.html.twig', array(
            "contrats" => $contrats
        ));
    }
    ...
    public function pdfAction(Request $request,$id)
    {
        ...
        $html = $this->renderView("@Baskel/Default/pdf.html.twig", array(
                'contrat' => $c
            )
        );
        $filename = "Contrat";
